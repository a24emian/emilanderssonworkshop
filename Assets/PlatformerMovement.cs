...
// [SerializeField] private float gravityMultiplier = 1; //unused
    ...
    public bool controlEnabled { get; set; } = true; // You can edit this variable
    from Unity Events
...
// Platformer specific variables
    ...
    private LayerMask groundLayer = ~0; // ~0 is referring to EVERY layer. Do you
    want a specific layer? Serialize the variable and assign the Layer of your choice.
...
// Flip sprite according to direction (if a sprite renderer has been
assigned)
if (spriteRenderer)
{
...
// Write movement animation code here. (Suggestion: send your current
velocity into the Animator for both the x- and y-axis.)
}
private bool IsGrounded()
{
// Is our groundCheckCollider touching the groundLayer? If so, return the
value "true"
